    ...
    <div class="container">
            ...
            <div class="bread">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> عمل تقارير شامل عن عقود الصيانة </li>
                    </ol>
                </nav>
            </div>
            <div class="title text-right">
                <h6> <i class="fa fa-plus"></i> عمل تقارير شامل عن عقود الصيانة </h6>
            </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (isset($_POST['car_state'])) {
                ...
                $stmt = $connect->prepare("SELECT * FROM fire WHERE 
